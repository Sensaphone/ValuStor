...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(valustor)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(valustor)
ZEND_DECLARE_MODULE_GLOBALS(valustor)
#define SWIG_ErrorMsg() (valustor_globals.error_msg)
#define SWIG_ErrorCode() (valustor_globals.error_code)
#ifdef __GNUC__
...
static void valustor_init_globals(zend_valustor_globals *globals ) {
...
ZEND_NAMED_FUNCTION(_wrap_swig_valustor_alter_newobject) {
  zval args[2];
  swig_object_wrapper *value;
...
ZEND_NAMED_FUNCTION(_wrap_swig_valustor_get_newobject) {
  zval args[1];
  swig_object_wrapper *value;
...
/* init section */
zend_module_entry valustor_module_entry = {
...
zend_module_entry* SWIG_module_entry = &valustor_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &valustor_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(valustor)
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(valustor, valustor_init_globals, NULL);
